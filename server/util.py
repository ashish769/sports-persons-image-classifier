...
def classify_image(image_base_64_data,file_path=None):
    ...
    result=[]
    for img in imgs:
        small_raw_img=cv2.resize(img,(32,32))
        img_har=w2d(img,'db1',5)
        scalled_img_har=cv2.resize(img_har,(32,32))
        combine_img=np.vstack((small_raw_img.reshape(32*32*3,1),scalled_img_har.reshape(32*32,1)))
...
def get_cv2_image_from_base64_string(b64str):
    if ',' in b64str:
        ...
        encoded_data = b64str  # Assume raw base64 string
